...
import { Home, ChevronRight } from 'heroicons-react';

const PageHeading = (props) => {
  const { title, breadCrumbs, meta, buttons } = props;
      ...
      {breadCrumbs && (
        <div>
          <nav className="hidden sm:flex items-center text-sm leading-5 font-medium">
            ...
            >
              <Home className="flex-shrink-0 h-5 w-5 text-gray-500" />
            </a>
            <ChevronRight className="flex-shrink-0 mx-2 h-5 w-5 text-gray-500" />
            <a
              href="#"
              className="text-gray-400 hover:text-gray-200 transition duration-150 ease-in-out"
            >
